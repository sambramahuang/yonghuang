import { Check, ChevronDown, GitBranch, Send, X } from "lucide-react";
...
export type ResolveAction = "accept" | "reject" | "submit";
...
interface Props {
  ...
  onResolve: (clauseId: string, action: ResolveAction, reason?: RejectionReason) => void;
}
